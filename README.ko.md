...
다양한 AI 코딩 에이전트(Antigravity, Cursor, Cline 등)가 다른 대화 세션으로 전환할 때, 개발 진행 상황과 환경을 유실 없이 그대로 이어서 진행할 수 있도록 설계된 크로스 플랫폼 및 범용 시스템 프롬프트 구성입니다.
